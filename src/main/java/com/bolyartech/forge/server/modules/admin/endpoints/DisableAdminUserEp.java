...
public class DisableAdminUserEp extends StringEndpoint {
    private static final int ERROR_USER_NOT_FOUND = -100;
    private static final int ERROR_CANNOT_DISABLE_YOURSELF = -101;

    public DisableAdminUserEp(Handler<String> handler) {
        super(HttpMethod.POST, "admin_user_disable", handler);
    }
